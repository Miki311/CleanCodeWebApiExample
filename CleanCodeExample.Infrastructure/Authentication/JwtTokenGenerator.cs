...
public class JwtTokenGenereator : IJwtTokenGenereator
{
    private readonly JwtSettings _jwtSettings;
    private readonly IDateTimeProvider _dateTimeProvider;

    public JwtTokenGenereator(IDateTimeProvider dateTimeProvider, IOptions<JwtSettings> jwtOptions)
    {
    ...
    public string GenerateToken(Guid userId, string firstName, string lastName)
    {
        ...
        var securityToken = new JwtSecurityToken(
            ...
            expires: _dateTimeProvider.UtcNow.AddMinutes( double.Parse(_jwtSettings.ExpiryMinutes)),
            claims: claims,
